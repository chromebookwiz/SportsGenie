...
export const env = {
  ...
  webLlmModels: toList(
    ...
    'Hermes-3-Llama-3.1-8B-q4f16_1-MLC,Hermes-3-Llama-3.1-8B-q4f32_1-MLC,Hermes-2-Pro-Mistral-7B-q4f16_1-MLC,Hermes-2-Pro-Llama-3-8B-q4f16_1-MLC,Hermes-2-Pro-Llama-3-8B-q4f32_1-MLC'
  ),
  webLlmModel: process.env.EXPO_PUBLIC_WEBLLM_MODEL ?? 'Hermes-3-Llama-3.1-8B-q4f16_1-MLC',
